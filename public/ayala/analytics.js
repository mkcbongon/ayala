        ...
        return function (b) {
            ...
            a: {
                ...
                for (var f = 0; f < e.length; f++) {
                    var h = e[f].split("=");
                    if (
                        "_gl" === decodeURIComponent(h[0]).replace(/\+/g, " ")
                    ) {
                        e = h.slice(1).join("=");
                        break a;
                    }
    ...
    function sa(a, b, c) {
        if (c && c.action) {
            ...
            if ("get" === d) {
                ...
                "post" === d &&
                    ((a = Y(a, b, c.action)), C.test(a) && (c.action = a));
        }
    }
    function fa(a) {
        try {
...
(function () {
    ...
    var ea = function (a) {
        ...
        ka = function (a) {
            return (
                "[object Array]" == Object.prototype.toString.call(Object(a))
            );
        },
        qa = function (a) {
        ...
        Id = function (a, b, c, d, e) {
            if (!ff) {
                ...
                try {
                    ff = window.trustedTypes.createPolicy(
                        "google-analytics",
                        ff
                    );
                } catch (ca) {}
            ...
            if (a) {
                var g =
                    (M.querySelector && M.querySelector("script[nonce]")) ||
                    null;
                g = g
                    ? g.nonce ||
                      (g.getAttribute && g.getAttribute("nonce")) ||
                      ""
                    : "";
                c
                    ? ((e = d = ""),
        ...
        of = function (a, b) {
            ...
            if (/^(https?|android-app):\/\//i.test(c)) {
                ...
                if (!de(c, a))
                    return b &&
                        ((b = a.replace(/\./g, "-") + ".cdn.ampproject.org"),
                        de(c, b))
                        ? void 0
                        : c;
            }
    ...
    var Qa = window,
        ...
        G = function (a) {
            ...
            if (
                (b && b.ioo && b.ioo()) ||
                Za.documentElement.hasAttribute(
        ...
        wd = function (a, b, c, d) {
            ...
            g.onreadystatechange = function () {
                if (4 == g.readyState) {
                    if (
                        d &&
                        "text/plain" === g.getResponseHeader("Content-Type")
                    )
                        try {
    ...
    function Sa(a) {
        ...
        if (rf(a))
            if (((ca = P(a, Na)), (l = sf[ca])))
                ...
                (vf[ca] = vf[ca] || []),
                    30 > vf[ca].length && vf[ca].push(uf(a));
    }
    function Hc(a) {
        ...
        if ((b = h(b).pending_experiments)) {
            ...
            for (d in b)
                b.hasOwnProperty(d) &&
                    b[d] &&
                    c.push(
                        encodeURIComponent(d) + "." + encodeURIComponent(b[d])
                    );
            var d = c.join("!");
        } else d = void 0;
    ...
    function Pe(a) {
        try {
            if (!a.get(Qe) && (a.set(Qe, !0), !a.get("&gtm"))) {
                ...
                lf(be("gtm_debug")) && (b = 2);
                !b &&
                    D(M.referrer, "https://tagassistant.google.com/") &&
                    (b = 3);
                !b && Ee(M.cookie.split("; "), "__TAG_ASSISTANT=x") && (b = 4);
                b ||
                    ((c = M.documentElement.getAttribute(
    ...
    function pd(a) {
        ...
        if ((e = (e = O.navigator) ? e.plugins : null) && e.length)
            for (g = 0; g < e.length && !l; g++)
                (ca = e[g]),
                    -1 < ca.name.indexOf("Shockwave Flash") &&
                        (l = ca.description);
        if (!l)
            try {
                    ...
                    c = function () {
                        if (!b && rc(a)) {
                            ...
                            d.removeEventListener
                                ...
                                : d.detachEvent &&
                                  d.detachEvent("onvisibilitychange", c);
                        }
                    };
        ...
        for (var b = [], c = 0; c < arguments.length; c++) {
            ...
            try {
                (d = new sc(arguments[c])),
                    d.g
                        ? C(d.aa[0], d.aa[1])
                        : (d.i && (d.ha = y(d.da, d.aa[0], d.X, d.W)),
                          b.push(d)),
                    Z.ra(arguments[c]);
            } catch (e) {}
        }
        ...
        try {
            if (a.u) a.u.call(O, N.j("t0"));
                ...
                if (a.A) {
                    if (
                        "t0" == a.da &&
                        ((b = N.create.apply(N, a.aa)), null === b)
                    )
                        return !0;
